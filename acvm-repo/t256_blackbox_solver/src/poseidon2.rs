...
//     ) -> (Vec<ark_tom256::Fr>, Vec<ark_tom256::Fr>) {
...
//             &inputs.into_iter().map(into_old_ark_field).collect::<Vec<ark_tom256::Fr>>(),
//         );
